...
public class RoomFourExitTransition : MonoBehaviour {
    /******* PUBLIC VARIABLES *******/
    [Header("Player Info")]
    ...
    public GameObject NextRoomInstructionText;
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.tag == "Player") {
            ...
            // update UI
            NextRoomInstructionText.GetComponent<TMP_Text>().fontStyle = NextRoomInstructionText.GetComponent<TMP_Text>().fontStyle | FontStyles.Strikethrough;
            NextRoomInstructionText.GetComponent<TMP_Text>().color = new Color32(100, 255, 100, 215);
            NextRoomInstructionText.transform.GetChild(0).gameObject.SetActive(false);
            NextRoomInstructionText.transform.GetChild(1).gameObject.SetActive(true);
            ...
            // activate next room's enemies
            RoomFiveEnemyParentGameObject.SetActive(true);
        }
    }
}