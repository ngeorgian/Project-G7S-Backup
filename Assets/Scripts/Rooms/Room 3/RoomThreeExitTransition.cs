...
public class RoomThreeExitTransition : MonoBehaviour {
    /******* PUBLIC VARIABLES *******/
    [Header("Player Info")]
    ...
    [Tooltip("Text from room 3 to turn off")]
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.tag == "Player") {
            ...
            RespawnButton.GetComponent<RespawnButton>().DoorBlockerGameObject = DoorBlockerGameObject;
            ...
            RoomFourEnemyParentGameObject.SetActive(true);
        }
    }
}